...
public class IngredientNormalizationIntegrationTests : IAsyncLifetime
{
    ...
    public async Task NormalizeAsync_QueriesMongoDB_ReturnsCanonicalForm()
    {
        ...
        // Act
        var result = await _normalizer!.NormalizeAsync(providerId, providerCode);
    ...
    public async Task NormalizeBatchAsync_MultipleIngredients_QueriesEfficientlyWithDifferentProviders()
    {
        ...
        // Act
        var result = await _normalizer!.NormalizeBatchAsync(providerId, codes);
    ...
    public async Task NormalizeAsync_FrequentlyUsedIngredient_UsesCacheToReduceDatabaseQueries()
    {
        ...
        var result1 = await _normalizer!.NormalizeAsync(providerId, providerCode);
        var result2 = await _normalizer.NormalizeAsync(providerId, providerCode);
        var result3 = await _normalizer.NormalizeAsync(providerId, providerCode);
    ...
    public async Task NormalizeAsync_DifferentProviders_MaintainSeparateMappings()
    {
        ...
        // Act
        var result1 = await _normalizer!.NormalizeAsync(provider1, code);
        var result2 = await _normalizer.NormalizeAsync(provider2, code);
    ...
    public async Task NormalizeAsync_UpdatedMapping_ReflectsInSubsequentCalls()
    {
        ...
        var result2 = await newNormalizer.NormalizeAsync(providerId, providerCode);
