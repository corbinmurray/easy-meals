...
public static class ResiliencyPolicies
{
    ...
    public static readonly ResiliencyPolicy Aggressive = new(RetryCount: 5, BaseDelay: TimeSpan.FromMilliseconds(100));
    public static readonly ResiliencyPolicy Conservative = new(RetryCount: 2, BaseDelay: TimeSpan.FromSeconds(1));
}
