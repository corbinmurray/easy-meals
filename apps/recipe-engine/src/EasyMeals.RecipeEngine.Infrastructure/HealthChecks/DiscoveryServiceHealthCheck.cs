...
public class DiscoveryServiceHealthCheck : IHealthCheck
{
	...
	public DiscoveryServiceHealthCheck(IDiscoveryServiceFactory discoveryServiceFactory)
	{
		_discoveryServiceFactory = discoveryServiceFactory ?? throw new ArgumentNullException(nameof(discoveryServiceFactory));
	}
		...
		CancellationToken cancellationToken = default)
	{
		try
		{
			...
			var staticService = _discoveryServiceFactory.CreateDiscoveryService(DiscoveryStrategy.Static);
			var dynamicService = _discoveryServiceFactory.CreateDiscoveryService(DiscoveryStrategy.Dynamic);
			var apiService = _discoveryServiceFactory.CreateDiscoveryService(DiscoveryStrategy.Api);
