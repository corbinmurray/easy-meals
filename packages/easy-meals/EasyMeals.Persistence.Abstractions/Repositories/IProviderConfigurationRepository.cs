...
public interface IProviderConfigurationRepository
{
    ...
    /// Results should be cached at the application layer.
    /// </remarks>
    ...
    /// hyphens only (e.g., "hello-fresh", "all-recipes").
    /// </para>
    /// <para>
    ...
    /// <param name="ct">Cancellation token.</param>
    /// <exception cref="Exceptions.ConcurrencyException">If optimistic concurrency check fails.</exception>
