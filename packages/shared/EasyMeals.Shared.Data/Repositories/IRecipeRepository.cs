...
public interface IRecipeRepository : IRepository<RecipeDocument>
{
    ...
    Task<PagedResult<RecipeDocument>> GetBySourceProviderAsync(string sourceProvider, int pageNumber, int pageSize, bool includeInactive = false,
    ...
    Task<IEnumerable<RecipeDocument>> GetByTimeConstraintsAsync(int? maxPrepTime = null, int? maxCookTime = null,
        CancellationToken cancellationToken = default);
    ...
    Task<PagedResult<RecipeDocument>> GetByTagsAsync(IEnumerable<string> tags, int pageNumber, int pageSize,
        CancellationToken cancellationToken = default);
    ...
    Task<PagedResult<RecipeDocument>> GetByNutritionalCriteriaAsync(int? maxCalories = null, decimal? minProtein = null, int pageNumber = 1,
