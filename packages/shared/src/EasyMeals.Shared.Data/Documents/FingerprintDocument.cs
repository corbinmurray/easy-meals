...
{
    /// <summary>Content was successfully scraped</summary>
    Success,

    /// <summary>Scraping failed due to an error</summary>
    Failed,

    /// <summary>Content was skipped (e.g., not a recipe page)</summary>
    Skipped,

    /// <summary>Content is being processed</summary>
    Processing,

    /// <summary>Content was blocked by anti-bot measures</summary>
    Blocked
}
...
{
    /// <summary>Quality assessment unknown</summary>
    Unknown = 0,

    /// <summary>Poor quality - missing key elements</summary>
    Poor = 1,

    /// <summary>Acceptable quality - has basic recipe data</summary>
    Acceptable = 2,

    /// <summary>Good quality - has most recipe elements</summary>
    Good = 3,

    /// <summary>Excellent quality - complete recipe with rich metadata</summary>
    Excellent = 4
}
